...
const AllRooms = () => {
  ...
  // Function to sort room based on selected sort options
  const sortRooms = (a, b) => {
          ...
          <div className="px-5 pt-5">
            ...
            {roomTypes.map((room, index) => (
              <CheckBox
                ...
                onChange={(checked) =>
                  handleFilterChange(checked, "roomType", room)
                }
              />
            ))}
          </div>
          <div className="px-5 pt-5">
            ...
            {priceRanges.map((range, index) => (
              <CheckBox
                ...
                onChange={(checked) =>
                  handleFilterChange(checked, "priceRange", range)
                }
              />
            ))}
          </div>
